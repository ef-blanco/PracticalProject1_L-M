...
package uniandes.lym.parserJavaCC.interfaz;


import javax.swing.*;

import uniandes.lym.parserJavaCC.mundoParser.MundoParsers;
...
public class ConsolaParsers extends JPanel{
	...
	/* para las extensiones debe cambiar la inicializaci�n de autos que ahora est�n amarradas a FraseAceptable(i) */
	 ...
	 */
	static private JTextArea orden = new JTextArea(20,50);
...
public static void relaunch(int dim){
	...
	/**
	 * Ejecuta sincr�nicamente la orden de escrbir en TextArea sistema
	 * @param msg
	 */
	...
	private void initMenu() {
		...
		itemAbout.addActionListener(new ActionListener(){
			public void actionPerformed(ActionEvent e) {
				...
				m.showMessage("About...","Probador de Aut�matas");
			}
		});
